            ...
            <Card className="z-10 w-full max-w-md border-zinc-200/50 bg-white/80 shadow-2xl backdrop-blur-xl dark:border-zinc-800/50 dark:bg-zinc-900/80 animate-in fade-in zoom-in duration-500">
                ...
                <CardContent className="space-y-4 pt-4">
                    <div className="space-y-2 group">
                        <label className="text-xs font-medium text-zinc-500 uppercase tracking-wider group-focus-within:text-red-600 transition-colors">Email</label>
                        <Input
                            type="email"
                    ...
                    <div className="space-y-2 group">
                        <label className="text-xs font-medium text-zinc-500 uppercase tracking-wider group-focus-within:text-red-600 transition-colors">Parol</label>
                        <Input
                            type="password"
                            placeholder="••••••••"
                            className="bg-zinc-50/50 border-zinc-200 focus:border-red-500 focus:ring-red-500/20 dark:bg-zinc-900/50 dark:border-zinc-800 transition-all duration-300"
                    ...
                    <Button className="w-full bg-gradient-to-r from-red-600 to-red-700 hover:from-red-700 hover:to-red-800 text-white shadow-lg shadow-red-500/20 h-11 text-base font-medium transition-all hover:scale-[1.02] active:scale-[0.98]">
                ...
                <CardFooter className="flex flex-col space-y-4 pt-2">
                    <div className="text-center text-sm text-zinc-500">
                        Hisobingiz yo'qmi?{" "}
                        <Link href="#" className="font-semibold text-red-600 hover:text-red-700 hover:underline">
                            Ro'yxatdan o'tish
                        </Link>
                    </div>
                    <div className="relative w-full">
                        ...
                        <div className="relative flex justify-center text-xs uppercase">
                            <span className="bg-white/80 px-2 text-zinc-400 dark:bg-zinc-900/80">Yoki</span>
                        </div>
                    </div>
